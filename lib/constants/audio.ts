...
export const AMBIENT_SOUNDS: AmbientSoundDefinition[] = [
    ...
    },
    {
        id: 'campfire',
        name: 'Campfire',
        description: 'Crackling campfire in nature',
        icon: 'Flame',
        category: 'nature',
        src: '/sounds/camp-ambience.mp3',
        defaultVolume: 40,
        tags: ['fire', 'camp', 'night'],
    },
    {
        id: 'mountain-wind',
        name: 'Mountain Wind',
        description: 'Strong wind in the mountains',
        icon: 'Wind',
        category: 'nature',
        src: '/sounds/mountain-wind.mp3',
        defaultVolume: 45,
        tags: ['wind', 'mountain', 'cold'],
    },
    {
        id: 'lakeshore',
        name: 'Lakeshore',
        description: 'Calm water continuously lapping',
        icon: 'Waves',
        category: 'nature',
        src: '/sounds/lakeshore-waves.mp3',
        defaultVolume: 40,
        tags: ['lake', 'water', 'calm'],
    },
    {
        id: 'riverbank',
        name: 'Riverbank',
        description: 'Flowing river water ambiance',
        icon: 'Droplets',
        category: 'nature',
        src: '/sounds/riverbank.mp3',
        defaultVolume: 45,
    ...
    },
    {
        id: 'seaside-wind',
        name: 'Seaside Wind',
        description: 'Wind blowing near the sea',
        icon: 'Wind',
        category: 'nature',
        src: '/sounds/seaside-wind.mp3',
        defaultVolume: 40,
        tags: ['wind', 'sea', 'beach'],
    },
    {
        id: 'harbor',
        name: 'Harbor',
        description: 'Seagulls and water at the harbor',
        icon: 'Anchor',
        category: 'nature',
        src: '/sounds/harbor.mp3',
        defaultVolume: 35,
        tags: ['harbor', 'sea', 'birds'],
    },
